$(document).ready(function() {
    ...
    function update_gearbox() {
        ...
        $('#gear_selector').draggable("option","grid", [gear_step_px, gear_step_px]);
    }
    ...
    $('#gear_selector').draggable({
        ...
        scroll: false,
        snap: true,
        grid: [gear_step_px, gear_step_px],
    ...
    function update_battery_level() {
        var voltage = parseInt ($('#lb_bat').text() || 0);
        var max_voltage = 12;
        var min_voltage = 9;
        var max_level = max_voltage - min_voltage;
        var current_level = max_voltage - voltage;
        var steps = 14;
        var one_step = steps / max_level;
        var current_steps = current_level * one_step - one_step;
